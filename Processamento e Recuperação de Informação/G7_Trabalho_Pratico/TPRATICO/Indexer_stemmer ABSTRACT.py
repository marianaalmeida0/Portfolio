...
with open('pub_abstracts.json','r') as f:abstract=f.read()
#Load JSON File
pubName = ujson.loads(publication)
pubAbstract = ujson.loads(abstract)
...
with open('publication_list_stemmed_abstract.json', 'w') as f:
    ujson.dump(pub_list_first_stem, f)

with open('publication_indexed_dictionary_abstract.json', 'w') as f:
